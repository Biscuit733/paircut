...
export const xiaohongshuShare: CouplePosterTemplate = {
  ...
  elements: [
    ...
    { id: 'note', type: 'text', text: '#Biscuit #一丁点甜 #小叮 #阿棠', x: 88, y: 1022, width: 900, fontSize: 28, fontFamily: '"Microsoft YaHei", sans-serif', fontWeight: 400, color: '#737373', textAlign: 'left', letterSpacing: 1, editable: true, zIndex: 3 },
  ],
}
