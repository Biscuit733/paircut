...
export const xhsCutePost: CouplePosterTemplate = {
  ...
  elements: [
    ...
    { id: 'caption', type: 'text', text: '小叮和阿棠的一丁点甜', x: 230, y: 900, width: 620, fontSize: 30, fontFamily: 'YouYuan, "Microsoft YaHei", sans-serif', fontWeight: 600, color: '#3f3f3f', textAlign: 'center', letterSpacing: 2, editable: true, zIndex: 5 },
    ...
    { id: 'title', type: 'text', text: 'Biscuit 的一丁点甜日常', x: 46, y: 1000, width: 980, fontSize: 32, fontFamily: '"Microsoft YaHei", sans-serif', fontWeight: 600, color: '#333333', textAlign: 'left', editable: true, zIndex: 5 },
  ],
}
