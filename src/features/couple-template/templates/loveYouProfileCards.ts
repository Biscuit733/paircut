...
export const loveYouProfileCards: CouplePosterTemplate = {
  ...
  elements: [
    ...
    { id: 'love', type: 'text', text: 'Love', x: 120, y: 315, width: 260, fontSize: 74, fontFamily: '"Edwardian Script ITC", "Bickham Script Pro", "Lucida Handwriting", "Brush Script MT", cursive', fontWeight: 400, color: '#171717', textAlign: 'center', letterSpacing: 0, shadowColor: 'rgba(0,0,0,0.08)', shadowBlur: 5, shadowOffsetY: 3, editable: true, zIndex: 3 },
    { id: 'you', type: 'text', text: 'You', x: 120, y: 855, width: 260, fontSize: 78, fontFamily: '"Edwardian Script ITC", "Bickham Script Pro", "Lucida Handwriting", "Brush Script MT", cursive', fontWeight: 400, color: '#171717', textAlign: 'center', letterSpacing: 0, shadowColor: 'rgba(0,0,0,0.08)', shadowBlur: 5, shadowOffsetY: 3, editable: true, zIndex: 3 },
